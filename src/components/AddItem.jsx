    ...
    <div className="container p-5 text-light-1 font-OpenSans rounded-lg bg-dark-2 h-screen font-bold flex flex-col justify-between sticky top-0 right-0">
      <div>
        <div className="flex justify-between mb-3">
          ...
          <button className="hover:bg-dark-4 rounded px-2" type="button" onClick={CloseAddItem}>
      ...
      <div className="flex justify-evenly">
        <button className="bg-dark-2 rounded-lg px-10 py-2.5 border border-light-3 text-light-1 text-xs" onClick={CloseAddItem}>
          Cancel
        </button>
